...
\usepackage{subcaption, sidecap,floatrow}
...
\usepackage{bm}
% Easier to work with spaces after commands.
\usepackage{xspace}
...
\def\xmode{\textcolor{x_axis_color}{x}-mode\xspace}
\def\ymode{\textcolor{y_axis_color}{y}-mode\xspace}
\def\zmode{\textcolor{z_axis_color}{z}-mode\xspace}
