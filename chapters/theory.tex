...
Gas damping on levitated micrometer sized particles has been studied by \textcite{millen}. For pressures above \qty{1E-6}{\milli\bar} and $K_n \ll 1$ stochastic forces dominate the damping rate. The damping rate in this case is given by \autoref{eqn:gas-damping-rate}.
